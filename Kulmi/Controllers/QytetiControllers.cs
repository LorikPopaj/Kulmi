...
namespace Kulmi.Controllers
{
    ...
    public class QytetiController : ControllerBase
    {
        ...
        {
            string query = @"
                select QytetiId, QytetiName from Qyteti
            ";
        ...
        public JsonResult Post(Qyteti qt)
        {
            ...
            using (SqlConnection myCon = new SqlConnection(sqlDataSource))
            {
                ...
                using (SqlCommand myCommand = new SqlCommand(query, myCon))
                {
                    myCommand.Parameters.AddWithValue("@QytetiName", qt.QytetiName);
                    myReader = myCommand.ExecuteReader();
                    table.Load(myReader);
                    myReader.Close();
                    myCon.Close();
        ...
        [HttpPut]
        public JsonResult Put(Qyteti qt)
        {
            string query = @"
                update Qyteti
            ...
            using (SqlConnection myCon = new SqlConnection(sqlDataSource))
            {
                ...
                using (SqlCommand myCommand = new SqlCommand(query, myCon))
                {
                    ...
                    myCommand.Parameters.AddWithValue("@QytetiId", qt.QytetiId);
                    myCommand.Parameters.AddWithValue("@QytetiName", qt.QytetiName);
                    myReader = myCommand.ExecuteReader();
                    table.Load(myReader);
                    myReader.Close();
